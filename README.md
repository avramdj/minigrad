...
[directed acyclic graph](https://en.wikipedia.org/wiki/Directed_acyclic_graph) of the operations and values that produced `z` and visiting it in reverse topological order.
